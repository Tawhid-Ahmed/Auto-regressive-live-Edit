# Thesis Presentation (V3) — Long-Form Knowledge Editing for Vision–Language Models

**Title:** *Autoregressive Chunk-Wise Editing for Long-Form Knowledge in Vision–Language Models*

**Audience:** MSc thesis progress / defense · **Duration:** ~20–22 min · **Slides:** 25 + backup

> V3 changes vs V2: adds **four methodology slides with mathematical notation** — formal edit problem, chunk decomposition & AR loop, LiveEdit MoE/residual update & training loss, and evaluation metrics — grounded in the project codebase (`liveedit.py`, `chunk_utils.py`, `vllm_editor_eval.py`).
...
3. Word doc: `python tools/build_thesis_presentation_v3_docx.py` → `doc/THESIS_PRESENTATION_V3.docx`.
4. For the architecture/lifelong/AR slides you may also **screenshot the real figures** from the two base PDFs and cite them.
