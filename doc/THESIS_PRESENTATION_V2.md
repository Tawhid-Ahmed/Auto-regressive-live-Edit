# Thesis Presentation (V2) — Long-Form Knowledge Editing for Vision–Language Models

**Title:** *Autoregressive Chunk-Wise Editing for Long-Form Knowledge in Vision–Language Models*

**Audience:** MSc thesis progress / defense · **Duration:** ~18–20 min · **Slides:** 20 + backup

> V2 changes vs V1: introduction & problem statement are **domain-general** (not framed around the two base papers); literature review covers **6+ recent works**; diagrams **mirror the base-paper figures** (LiveEdit Fig. 1 lifelong concept, LiveEdit Fig. 2 architecture, AnyEdit Fig. 1 single-token vs autoregressive).
...
## Slide 14 — Methodology: overall pipeline
...
## Slide 15 — Methodology: VLKEB-long construction
...
## Slide 16 — Results: single-pass vs autoregressive
...
## Slide 17 — Results: granularity (chunk size) ablation
...
2. The matching deck is generated by `tools/build_thesis_presentation_v2.py` → `doc/THESIS_PRESENTATION_V2.pptx`.
3. For the architecture/lifelong/AR slides you may also **screenshot the real figures** from the two base PDFs and cite them.
